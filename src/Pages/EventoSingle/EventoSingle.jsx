...
export const EventoSingle = () => {
  ...
  useEffect(() => {
    ...
    window.fbq?.('track', 'ViewContent', {
      content_name:     evento.artista,
      content_category: evento.categoria,
      content_ids:      [evento._id],
      content_type:     'product',
      value:            evento.zonas?.[0]?.precio ?? 0,
      currency:         'MXN',
    });
  }, [evento]);
  ...
  const handleAddToCart = () => {
    ...
    window.fbq?.('track', 'AddToCart', {
      ...
      content_ids:  [evento._id],
      value:        esZona2x1
        ? selectedZone.precio * (qty / 2)
        : selectedZone.precio * qty,
      currency:     'MXN',
      num_items:    qty,
    });
            ...
            {selectedZone ? (
              <>
                <div className="es-cta-card__zone">
                  <span className="es-cta-card__dot" style={{ background: colorActivo }} />
                  <span className="es-cta-card__name">{selectedZone.nombre}</span>
                  {esZona2x1 && (
                ...
                <div className="es-qty-ctrl">
                  ...
                  <button
                    className="es-qty-btn"
                    onClick={() => setQty((q) => Math.min(maxBoletos, q + paso))}
                ...
                <div className="es-cta-total" style={{ "--qty-color": colorActivo }}>
                  <span>Total</span>
